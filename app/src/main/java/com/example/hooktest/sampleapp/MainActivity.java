package com.example.hooktest.sampleapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button testFork = findViewById(R.id.test_fork);
        testFork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String resultString = testFork() == 0 ? "fork success":"fork failed";
                Toast.makeText(MainActivity.this, resultString, Toast.LENGTH_LONG).show();
            }
        });
