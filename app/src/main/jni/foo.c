...
Java_com_example_hooktest_sampleapp_MainActivity_testPassword(JNIEnv *env, jobject instance, jstring myString) {
...
JNIEXPORT jint JNICALL
Java_com_example_hooktest_sampleapp_MainActivity_testStrncmp(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_example_hooktest_sampleapp_MainActivity_testFork(JNIEnv *env, jobject instance) {
    return fork();
}